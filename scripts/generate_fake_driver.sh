...
declare -A files_metadata=(
    ...
    ["mouse_logo_matrix_effect_none"]="w;"
    ["mouse_logo_matrix_effect_reactive"]="w;"
    ["mouse_logo_matrix_effect_spectrum"]="w;"
    ["mouse_logo_matrix_effect_static"]="w;"
    ["mouse_logo_matrix_effect_wave"]="w;"
    ["mouse_matrix_brightness"]="rw;0"
    ["mouse_matrix_custom_frame"]="w;"
    ["mouse_matrix_effect_breath"]="w;"
    ["mouse_matrix_effect_custom"]="w;"
    ["mouse_matrix_effect_none"]="w;"
    ["mouse_matrix_effect_reactive"]="w;"
    ["mouse_matrix_effect_spectrum"]="w;"
    ["mouse_matrix_effect_static"]="w;"
    ["mouse_matrix_effect_wave"]="w;"
    ["mouse_scroll_acceleration"]="rw;0"
    ["mouse_scroll_led_brightness"]="rw;0"
    ["mouse_scroll_matrix_effect_breath"]="w;"
    ["mouse_scroll_matrix_effect_none"]="w;"
    ["mouse_scroll_matrix_effect_reactive"]="w;"
    ["mouse_scroll_matrix_effect_spectrum"]="w;"
    ["mouse_scroll_matrix_effect_static"]="w;"
    ["mouse_scroll_matrix_effect_wave"]="w;"
    ["mouse_scroll_mode"]="rw;0"
    ["mouse_scroll_smart_reel"]="rw;0"
    ["mouse_serial"]="r;MM00000000A4"
    ["nearby_mice"]="r;00ab"
    ["scan_for_mice"]="w;"
